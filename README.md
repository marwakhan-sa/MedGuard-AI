...
### Analysis in Progress (Live Status Steps)
![Checking NLM Database](./screenshots/loading1.png)
![Consulting Gemini AI](./screenshots/loading2.png)

### Gemini AI Safety Synthesis Panel
 ![AI Risk Summary](./screenshots/ai-summary.png)
  ![AI Risk Summary](./screenshots/questions.png)

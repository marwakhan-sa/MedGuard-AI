...
// Implement Vite middleware for development or Serve static build for production
async function startServer() {
  ...
  app.listen(PORT, "0.0.0.0", () => {
    console.log(`MedGuard full-stack server running on http://localhost:${PORT}`);
  });
}

// Only run the traditional listening server locally — Vercel runs this as a serverless function instead
